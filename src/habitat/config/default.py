...
_C.TASK.FOW_MAP.VISIBILITY_DIST = 2.0
_C.TASK.FOW_MAP.FOV = 79
# -----------------------------------------------------------------------------
# PICTURE_MAP
# -----------------------------------------------------------------------------
_C.TASK.PICTURE_MAP = CN()
_C.TASK.PICTURE_MAP.VISIBILITY_DIST = 2.0
...
_C.TASK.TOP_DOWN_MAP.FOG_OF_WAR.VISIBILITY_DIST = 2.0
...
_C.TASK.PICTURE_RANGE_MAP.FOG_OF_WAR.VISIBILITY_DIST = 2.0
