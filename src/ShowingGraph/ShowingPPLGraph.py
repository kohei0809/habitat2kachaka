...
plt.plot(df['time'], df['pspl'], color="blue", label="ppl")
...
#フォルダがない場合は、作成
p_dir = pathlib.Path("./result/val/ppl_graph")
if not p_dir.exists():
    p_dir.mkdir(parents=True)

#グラフの保存
plt.savefig('./result/val/ppl_graph/' + date + '.png')

#グラフの表示
plt.show()

print("Showing PPL graph is completed.")